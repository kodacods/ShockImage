...
public class CropSelection implements ImageOperation, java.io.Serializable {
    ...
    public BufferedImage apply(BufferedImage input) {
        ...
        System.out.println("points: " + SelectionActions.originPoint.x + " " + SelectionActions.originPoint.y);
        ...
        // BufferedImage output = new BufferedImage(SelectionActions.selWidth,
        // SelectionActions.selHeight,
        ...
        // Outcome: It crops, but repeating the process makes it... not work. It also
        // kind of explodes on the third crop.

        // I think it has to do with the input taking from the original image pre-crop.
        // I feel as if this code is way too simple. But what can I do to possibly fix
        // it???
        // It should work just like resize. But crop. But it doesn't...
        // I've tried the way my Resize does things. Same outcome... and besides that
        // other one is basically just conversion from
        // an Image to BufferedImage. This doesn't need correction, as it is already a
        // BufferedImage, but... huh...???????

        /*
         * Errors as of note:
         * Caused on 1st crop: None
         * Caused on 2nd crop: Returns 'must have an image opened first'. Otherwise may
         * or may not crop properly.
         * No idea why error message is triggered.
         * Caused on 3rd crop: Exception in thread "AWT-EventQueue-0"
         * java.awt.image.RasterFormatException: (x + width) is outside of Raster
         * Hmm.
         * 
         * Undo: Does not return to previous sizes unlike Resize until returning to the
         * first crop.
         * 
         * It's odd. It should be working. The getSubImage function is basically THE
         ...
         * However, the second one has the print prompts go *twice,* sans the 'output
         * height and width' messages. That's odd. That shouldn't happen...
         * And for that matter, the input's length and width don't change, either, as
         * expected.
         */
         ...
         * 
         * I've even tested the other mechanic that works similarly (resize) if it's
         * because its in a method outside of actionPerformed -
