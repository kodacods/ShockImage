 ...
 * the values of the neighboring pixels, using a radius, and can be implemented
 * by a convoloution.
 * </p>
 * 
 * <p>
...
public class GaussianBlur implements ImageOperation, java.io.Serializable {
    ...
    public BufferedImage apply(BufferedImage input) {
        ...
        BufferedImage output = FilterConvolution.applyConvolution(input, array, radius);
        return output;
    }
